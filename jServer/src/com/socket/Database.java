...
public class Database {
    ...
    public boolean userExists(String username){
        ...
        try{
            ...
            System.out.println("Database exception : Duplicate User)");
            return false;
        }
    }
    ...
    public static String getTagValue(String sTag, Element ele) {
	NodeList nlList = ele.getElementsByTagName(sTag).item(0).getChildNodes();
